...
class CHAIR(object):
    ...
    def gpt_caption_processor(self, max_workers=2):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--q_file", type=str, default='playground/data/obj_halbench_300_with_image.jsonl')
    parser.add_argument("--coco_path", type=str, default='playground/data/annotations/')
